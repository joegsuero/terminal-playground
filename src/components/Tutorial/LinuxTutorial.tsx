...
import { lessons } from "@/data/linuxLessions";

interface TutorialProps {
  onCommandSuggest: (command: string) => void;
}

export const Tutorial: React.FC<TutorialProps> = ({ onCommandSuggest }) => {
    ...
    <div className="h-full bg-card border border-border rounded-lg overflow-hidden">
      <div className="bg-secondary border-b border-border px-4 py-3">
        <div className="flex items-center gap-2 mb-2">
          ...
          <h2 className="text-lg font-semibold">Linux Tutorial</h2>
        </div>
